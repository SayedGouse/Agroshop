     ...
     <div className='container-fluid bg-light mt-3 p-3'>
        <div className='row mt-2'>
            ...
            return(<div className='col-lg-3 mt-2' key={data.id}>
                ...
                <p> <button className='btn btn-danger text-white' style={{width:"100px",fontSize:"18px"}}><a href={`/sendorder/${data.id}`} style={{textDecoration:"none",color:"white"}}> Buy </a> </button></p>
            </div>)
            }
                 )}
