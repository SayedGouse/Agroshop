...
const AddProduct = () => {
    ...
    const initialValues = {category:"",product_name:"",uom:"",qty:"",price:"",description:""}
  ...
  return (
    <div>
        ...
        <div className='mb-3'>
                   <textarea name='description' className='form-control' onChange={handleChange} defaultValue={formValues.description}></textarea>
        </div>
